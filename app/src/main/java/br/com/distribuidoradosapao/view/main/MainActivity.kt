...
import br.com.distribuidoradosapao.view.gallery.GalleryFragment
import br.com.distribuidoradosapao.view.home.HomeFragment
import br.com.distribuidoradosapao.view.slideshow.SlideshowFragment
...
class MainActivity : AppCompatActivity(),
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.nav_home -> navigateFragment(HomeFragment())
